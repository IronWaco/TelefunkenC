...
public class Mesa {
    ...
    private Carta Ca[][]=new Carta[50][50];
	    ...
	    public void agregar(Carta c, int i, int e) {
	        ...
	        if(i==e)
	        {
	                if((Caux[1].getNombre().equals(Caux[2].getNombre()) && Caux[2].getNombre().equals(Caux[3].getNombre()) || 
	                        ...
	                        (Caux[1].getNombre().equals(Caux[2].getNombre()) && Caux[3].getNombre().equals("Joker"))) &&
	                        Caux[1]!=null && Caux[2]!=null && Caux[3]!=null)
	                {
	                    nrofilas++;
                            //System.out.println("numero de filas "+nrofilas);
	                    for(int j=1; j<=e; j++)
	                    {
	                ...
	                else
	                {
	                    ...
	                    for(int k=1; k<=e; k++)
	                    {
	                        if(Caux[k].getNumero()==0)
                                {
                                    if(k==1)
                                    {
                                        o=(Caux[k+1].getNumero())-1;
                                    }
                                    else
                                    {
                                        if(k==2)
	    ...
	    public boolean ver_sopar2() {
	        ...
	        for(int i=1; i<=nrofilas; i++)
	        {
	            ...
	            if(Ca[i][1]!=null && Ca[i][2]!=null && Ca[i][3]!=null && 
	                    (Ca[i][1].getNombre().equals(Ca[i][2].getNombre()) && Ca[i][2].getNombre().equals(Ca[i][3].getNombre()) || 
	                    (Ca[i][1].getNombre().equals("Joker") && Ca[i][2].getNombre().equals(Ca[i][3].getNombre())) || 
	                    (Ca[i][1].getNombre().equals(Ca[i][3].getNombre()) && Ca[i][2].getNombre().equals("Joker")) ||
	                    (Ca[i][1].getNombre().equals(Ca[i][2].getNombre()) && Ca[i][3].getNombre().equals("Joker"))))
	            {
	                ...
	                if(swx==1)
	                {
	                    System.out.println("Tiene la posibilidad de sopar en la 'tricka' de "+Ca[i][1].getNombre());
	                }
	            }
	            else
	            {
	    ...
	    public boolean sopar(Carta x) {
	        int swx=0, sw=0, ce=0, cc=0, nombrex;
